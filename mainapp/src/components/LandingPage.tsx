    ...
    <div>
      <div className="flex">
        ...
        <div className="ml-auto flex items-center text-white">
          ...
          >
            All Products<LocalMallOutlinedIcon />
          </div>
          ...
          >
            Cart Product<ShoppingCartIcon />
            <span className="flex h-2 w-2 items-center justify-center rounded-full bg-white p-3 text-xs text-blue-900">{singleUser.userCartProd.length}</span>
          </div>
